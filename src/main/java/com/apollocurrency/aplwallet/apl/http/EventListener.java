...
class EventListener implements Runnable, AsyncListener, TransactionalDb.TransactionCallback {
    ...
    static final int eventTimeout = Math.max(Apl.getIntProperty("apl.apiEventTimeout"), 15);

    /** Blockchain processor */
    static final BlockchainProcessor blockchainProcessor = Apl.getBlockchainProcessor();

    /** Transaction processor */
    static final TransactionProcessor transactionProcessor = Apl.getTransactionProcessor();
     ...
     *
     * Apl event listeners will be added for the specified events
     *
     * @param   eventRegistrations      List of Apl event registrations
     ...
     *
     * @param   eventRegistrations      Apl event registrations
     * @throws  EventListenerException  Invalid Apl event
     */
    ...
    private class AplEventListener {
        ...
        /**
         * Add the Apl listener for this event
         */
        ...
        /**
         * Remove the Apl listener for this event
         */
        ...
        /**
         * Return the hash code for this Apl event listener
         *
         * @return                  Hash code
         */
        @Override
        ...
        /**
         * Check if two Apl events listeners are equal
         *
    ...
    static class EventRegistration {
         ...
         *
         * @param   event           Apl listener event
        ...
        /**
         * Return the Apl listener event
         *
         * @return                  Apl listener event
         */
        public Enum<? extends Enum> getEvent() {
            return event;
        }
